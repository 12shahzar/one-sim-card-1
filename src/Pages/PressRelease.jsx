      ...
      <div className="my-16">
        ...
        <ContentSection
          paragraphs={[
            ...
            "The OneSim IMEI Lock solution is designed to be user friendly unlike many IMEI SIM locks offered by other SIM providers where users have to call support and get permission to lock or unlock a SIM. Locking and unlocking the SIM with OneSim IMEI Lock is extremely simple and is completed in seconds with just a few clicks of the mouse using OneSimCard's OSCAR portal for SIM card management and reporting. Because the OSCAR portal is completely online, users can change their SIM lock settings anywhere in the world, and even on their Android Smartphone through OneSimCard M2M's IoT App available on Google Play Store (iOS 1SIM IoT app is coming soon).",
