  ...
  return (
    <div className="max-w-7xl mx-auto py-16 font-sora px-2 md:px-6">
      <ContentSection
        ...
        paragraphs={[
          "OneSimCard M2M has established itself as premium provider of IoT connectivity services in over 160 countries. The OneSimCard IoT SIM card features network redundancy in most countries and does not “steer” towards the least expensive network, but instead always chooses the best local network available.  These key features allow OneSimCard M2M to offer much better coverage and service reliability worldwide.",
          "Companies in need of M2M / IoT connectivity have come to rely on the outstanding products and services provided by OneSimCard M2M. Given the strong demand for our premium M2M SIM cards, we have created an Internet of Things business opportunity which allows our Distributors and Resellers to benefit from selling a premium IoT connectivity product.",
        ]}
      />
      <FeatureSection
        title="Distributor and Resellers Program"
        description="OneSimCard M2M Distributors and Resellers are M2M / IoT connectivity suppliers to corporate end users. They purchase M2M / IoT SIM cards (and corporate balance  if wanting to recharge customers' accounts directly) at wholesale prices and sell our OneSimCard M2M SIM cards independently to end user companies in need of  M2M / IoT connectivity services. OneSimCard provides the web tools necessary to allow Distributors and Reseller to set up corporate accounts, assign IoT SIM cards to a corporate account and apply balance to IoT SIM cards within corporate IoT SIM card accounts."
      ...
      <ContentSection
        ...
        paragraphs={[
          "IoT SIM Card Margin - Distributors and Resellers have the ability to purchase OneSimCard IoT SIM cards at wholesale discounts and then sell the M2M SIM cards to corporate users at full price.",
