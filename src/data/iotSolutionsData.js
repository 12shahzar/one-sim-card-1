...
const IoTSolutionsData = {
  ...
  SupplyChainTrackingAndTracing: {
    banner: {
      titleFirst: "OneSimCard M2M",
      titleLast: " for IoT",
      breadcrumb: [
        { label: "IoT Solutions", path: "/IoTSolutions" },
        { label: "Supply Chain Tracking and Tracing" },
      ],
    },
  ...
  Wearables: {
    ...
    title: "Wearables",
    paragraphs: [
      "IoT SIM cards are pivotal in enhancing the functionality and connectivity of wearable devices, which are increasingly popular for health monitoring, fitness tracking, and personal communication. These SIM cards provide the essential link for wearables to transmit and receive data seamlessly, enabling a host of advanced features and benefits.",
    ],
    features: [
      {
        description:
  ...
  MeterMonitoring: {
    banner: {
      ...
      breadcrumb: [
        { label: "IoT Solutions", path: "/IoTSolutions" },
        { label: "Meter Monitoring" },
      ],
    },
    title: "Meter Monitoring",
    paragraphs: [
      "IoT SIM cards play a crucial role in the functionality and efficiency of smart meters, which are essential components in modern energy management systems. Smart meters, used for measuring electricity, gas, and water consumption, rely on IoT SIM cards to provide real-time data transmission, remote monitoring, and enhanced control over utility usage.",
    ],
    features: [
      {
        description:
  ...
  MedicalMonitoring: {
    ...
    paragraphs: [
      "The integration of Internet of Things (IoT) technology in healthcare has revolutionized the way medical devices operate, improving patient care and streamlining medical processes. At the core of this transformation are IoT SIM cards, which provide the critical connectivity needed for medical devices to communicate, collect data, and function effectively.",
    ],
    features: [
      {
        description:
  ...
  DigitalAdvertisingUpdates: {
    banner: {
      titleFirst: "OneSimCard M2M",
      titleLast: " for IoT",
      breadcrumb: [
        { label: "IoT Solutions", path: "/IoTSolutions" },
        { label: "Digital Advertising Updates" },
      ],
    },
    title: "Digital Advertising Updates",
    paragraphs: [
      "IoT SIM cards are essential for modern digital signage, offering enhanced connectivity, real-time updates, and increased flexibility for deploying and managing content across various locations. Digital signage, widely used for advertising, information dissemination, and interactive displays, relies on the robust and reliable connectivity provided by IoT SIM cards to deliver timely and relevant content to audiences.",
    ],
    features: [
      {
        description:
  ...
  AgTech: {
    ...
    title: "AgTech",
    paragraphs: [
      "The integration of IoT SIM cards in agriculture technology (AgTech) is revolutionizing modern farming practices by providing robust connectivity and data transmission capabilities. These SIM cards play a crucial role in enabling precision agriculture, optimizing resource management, and enhancing overall farm productivity.",
    ],
    features: [
      {
        description:
  ...
  EVCharging: {
    ...
    title: "EV Charging",
    paragraphs: [
      "IoT SIM cards play a vital role in enhancing the functionality, efficiency, and user experience of electric vehicle (EV) charging infrastructure. By providing reliable and secure connectivity, these SIM cards enable real-time data transmission, remote monitoring, and intelligent management of EV charging stations.",
    ],
    features: [
      {
        description:
...
export default IoTSolutionsData;
